...
class D1Client {
    ...
    public function __construct() {
        ...
        $baseUrl = rtrim(
            getenv('D1_WORKER_URL') ?: 'https://mfinance.mrshalmyd.workers.dev',
            '/'
        );
    ...
    /**
     * Jalankan query SELECT ke Worker D1
     */
    public function query(string $sql, array $params = []): array {
        ...
        if (json_last_error() !== JSON_ERROR_NONE) {
            throw new Exception(
                "Invalid JSON from Worker: " . json_last_error_msg() .
        ...
        // Sesuai struktur Worker: { results: array, meta: {...} }
        return $data['results'] ?? [];
    }

    /**
     * Jalankan query INSERT/UPDATE/DELETE ke Worker D1
     */
